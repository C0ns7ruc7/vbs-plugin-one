...
function vbsagendaplugin_custom_login_styles() {
    ...
    if ( 'enable' === $styles ) {
        ...
        */
        ...
        wp_enqueue_style( 'vbsagendaplugin', plugin_dir_url( dirname( __FILE__ ) ) . 'public/css/vbsagendaplugin-login.css', array(), null, 'screen' );

        wp_enqueue_script( 'vbsagendaplugin', plugin_dir_url( dirname( __FILE__ ) ) . 'public/js/vbsagendaplugin-login.js', array(), null, true );
